          ...
          >
            ...
            >
              <div className="relative">
                <button 
                  onClick={() => setSelectedProject(null)} 
                  className="absolute top-2 right-2 text-white bg-azul-escuro rounded-full w-8 h-8 flex items-center justify-center z-10"
                >
                  X
                </button>
                <img 
              ...
              <div className="p-6">
                <h3 className="text-2xl font-bold text-azul-escuro mb-2">{selectedProject.title}</h3>
                <p className="text-neutro-texto">{selectedProject.description}</p>
              </div>
            </div>
          </div>
        )}
